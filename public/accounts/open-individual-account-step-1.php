<!-- Introduction -->
<section class="open-account-intro">
        <header>
           <div class="col-1">
       ...
       <form action="<?php echo url_for('/accounts/open-individual-account.php?step=2'); ?>" method="post">
            <div class="main-content">
                <div class="col-1">
                    <span>Are you already a citiFinance customer ?</span>
                </div>
                <div class="col-2">
                    <div class="col-2-row">
                        <div>
                            <input type="radio" id="radio-new-customer" name="new-customer" value="Yes" onclick="javascript:showOnRadioCheck('radio-new-customer')">
                        </div>
                        <div>
                    ...
                    <div class="col-2-row">
                        <div>
                            <input type="radio"  id="radio-not-new-customer" name="new-customer" value="No"  onclick="javascript:showOnRadioCheck('radio-not-new-customer')">
                        </div>
                        <div>
